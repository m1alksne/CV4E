...
random_sample_indices = random.sample(filtered_indices.tolist(), 2000)
...
validate_clips_final.to_csv('/home/michaela/CV4E_oss/pre_processing/labeled_data/validate_clips.csv', index=False)
train_clips_final.to_csv('/home/michaela/CV4E_oss/pre_processing/labeled_data/train_clips.csv', index=False)
